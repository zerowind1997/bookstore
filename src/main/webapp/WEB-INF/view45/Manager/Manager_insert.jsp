...
<article class="page-container">
	<form action="Manager_insertDeal" method="post" class="form form-horizontal" id="form-bean-edit">
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>登入账号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${userId }" placeholder="" id="userId" name="userId">
		</div>
	</div>
	<div class="row cl">
