...
<article class="page-container">
	<form action="Manager_updateDeal" method="post" class="form form-horizontal" id="form-bean-edit">
	<!-- <input type="hidden" name="oper" value="updateDeal" /> -->
	<input type="hidden" name="id" value="${BG_LOGINUSER_KEY.id}" />
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>新密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="newPass" name="newPass">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="checkPass" name="checkPass">
		</div>
	</div>
	<div class="row cl">
