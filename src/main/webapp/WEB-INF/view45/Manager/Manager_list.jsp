...
<body>
	...
	<div class="page-container">
		<form action="Manager_listDeal" method="get">
			...
			<div class="text-c">
				名称： <input type="text" class="input-text" style="width: 250px"
					placeholder="输入管理员姓名" id="userName" name="userName"
					value="${userName}">
				<button type="submit" class="btn btn-success radius" id="" name="">
					<i class="Hui-iconfont">&#xe665;</i> 搜管理员姓名
				</button>
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="item_add('添加管理员','Manager_insert','800','510')"
				class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>
					添加管理员</a></span> <span class="r">共有数据：<strong>${pagerItem.rowCount}</strong>
				条
			</span>
		</div>
		<div class="mt-20">
			<table
				...
				<tr class="text-c" id="${item.id}">
					...
					<a title="重置密码"
						href="javascript:;"
						onclick="item_detail('Manager_update','${item.id}','0')"
