...
<body>
	...
	<div class="page-container">
		<form action="NewsComment_listDeal" method="get">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="item_add('添加用户','NewsComment_insert','800','510')"
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg"
				...
				<tr class="text-c" id="${item.id}">
					...
					<a title="编辑"
						href="javascript:;"
						onclick="item_edit('编辑[id=${item.id}]','NewsComment_update?id=${item.id}','1','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe6df;</i></a> 
						<a title="查看" href="javascript:;" 
						onclick="item_detail('查看[Id=${item.id}]','NewsComment_detail?id=${item.id}','4','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe707;</i></a>
					</td>
				</tr>
	...
	$(function(){
		$("#clearSearch").click(function(){
			location.href = "NewsComment_list"
		});
	});
