...
<body>
	<nav class="breadcrumb">
		...
		用户中心 <span class="c-gray en">&gt;</span> 新闻报道管理 <a
	...
	<div class="page-container">
		<form action="NewsExcont_listDeal" method="get">
		...
		<div class="text-c">
			内容： <input type="text" class="input-text" style="width: 250px"
				placeholder="输入内容" id="content" name="content" value="${content}">
			<button type="submit" class="btn btn-success radius" id="" name="">
				<i class="Hui-iconfont">&#xe665;</i> 搜内容
			</button>
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="item_add('添加用户','NewsExcont_insert','800','510')"
		...
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg"
				...
				<tr class="text-c" id="${item.id}">
					...
					<a title="编辑"
						href="javascript:;"
						onclick="item_edit('编辑[id=${item.id}]','NewsExcont_update?id=${item.id}','1','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe6df;</i></a> 
						<a title="查看" href="javascript:;" 
						onclick="item_detail('查看[Id=${item.id}]','NewsExcont_detail?id=${item.id}','4','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe707;</i></a>
					</td>
				</tr>
