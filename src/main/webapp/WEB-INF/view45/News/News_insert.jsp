...
<article class="page-container">
	<form action="News_insertDeal" method="post" class="form form-horizontal" id="form-bean-edit">
	<!--<input type="hidden" name="oper" value="insertDeal" />-->
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>catId：</label>
