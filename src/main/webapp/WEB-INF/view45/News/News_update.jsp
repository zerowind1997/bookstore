...
<![endif]-->
<title>修改新闻${newsId}</title>
<meta name="keywords" content="H-ui.admin v3.1,H-ui网站后台模版,后台模版下载,后台管理系统模版,HTML后台模版下载">
<meta name="description" content="H-ui.admin v3.1，是一款由国人开发的轻量级扁平化网站后台模板，完全免费开源的网站后台管理系统模版，适合中小型CMS后台系统。">
</head>
<body>
<article class="page-container">
	<form action="News_updateDeal" method="post" class="form form-horizontal" id="form-bean-edit">
	<!-- <input type="hidden" name="oper" value="updateDeal" /> -->
	<input type="hidden" name="newsId" value="${newsId }" />	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>类目id：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${catId }" placeholder="" id="catId" name="catId">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="${title }" placeholder="" id="title" name="title">
		</div>
	</div>
