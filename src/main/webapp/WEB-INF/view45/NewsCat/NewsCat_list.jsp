	...
	<div class="page-container">
		...
		<div class="text-c">
			名称： <input type="text" class="input-text" style="width: 250px"
				placeholder="输入名称" id="catName" name="catName" value="${catName}">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="item_add('添加用户','NewsCat_insert','800','510')"
			...
			<table class="table table-border table-bordered table-bg"
				...
				<tr class="text-c" id="${item.catId}">
					...
					<a style="text-decoration: none"
						onClick="item_del(this,${item.catId})" href="javascript:;" title="删除" class="ml-5">
						<i class="Hui-iconfont">&#xe6e2;</i></a> 
					<a title="编辑"
						href="javascript:;"
						onclick="item_edit('编辑[id=${item.catId}]','NewsCat_update?id=${item.catId}','1','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe6df;</i></a> 
						<a title="查看" href="javascript:;" 
						onclick="item_detail('查看[Id=${item.catId}]','NewsCat_detail?id=${item.catId}','4','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe707;</i></a>
					</td>
				</tr>
