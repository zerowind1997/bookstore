...
<body>
	<nav class="breadcrumb">
		...
		用户中心 <span class="c-gray en">&gt;</span> 头条管理 <a
	...
	<div class="page-container">
		<form action="HeadLine_listDeal" method="get">
			...
			<div class="text-c">
				名称： <input type="text" class="input-text" style="width: 250px"
					placeholder="输入标题" id="lineName" name="lineName"
					value="${lineName}">
				<button type="submit" class="btn btn-success radius" id="" name="">
					<i class="Hui-iconfont">&#xe665;</i> 搜头条
				</button>
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="item_add('添加用户','HeadLine_insert','800','510')"
				class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>
					添加头条</a></span> <span class="r">共有数据：<strong>${pagerItem.rowCount}</strong>
				条
			</span>
		</div>
		<div class="mt-20">
			<table
				...
				<tr class="text-c" id="${item.id}">
					...
					<a style="text-decoration: none"
						onClick="item_del(this,${item.id})" href="javascript:;" title="删除" class="ml-5">
						<i class="Hui-iconfont">&#xe6e2;</i></a> 
					<a title="编辑"
						href="javascript:;"
						onclick="item_detail('编辑[id=${item.id}]','HeadLine_update?id=${item.id}','1','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe6df;</i></a> 
						<a title="查看" href="javascript:;" 
						onclick="item_detail('查看[id=${item.id}]','HeadLine_detail?id=${item.id}','4','800','500')"
						class="ml-5" style="text-decoration: none"><i
							class="Hui-iconfont">&#xe707;</i></a>
					</td>
				</tr>
	...
	<script type="text/javascript">
		...
		/*用户-查看*/
		function headLine_show(title, url, id, w, h) {
			layer_show(title, url, w, h);
		}
										...
										.ajax({
											...
											success : function(data) {
												$(obj)
														...
														.find(".td-manage")
														.prepend(
																'<a style="text-decoration:none" onClick="headLine_start(this,id)" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6e1;</i></a>');
												$(obj)
														.parents("tr")
														.find(".td-status")
														.html(
		...
		/*用户-启用*/
		function headLine_start(obj, id) {
			layer
					.confirm(
							'确认要启用吗？',
							function(index) {
										...
										.ajax({
											...
											success : function(data) {
												$(obj)
														...
														.find(".td-manage")
														.prepend(
																'<a style="text-decoration:none" onClick="headLine_stop(this,id)" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>');
												$(obj)
														.parents("tr")
														.find(".td-status")
														.html(
		...
		/*用户-编辑*/
		function headLine_edit(title, url, id, w, h) {
			layer_show(title, url, w, h);
		}
		/*密码-修改*/
