...
public class UIConst {
	...
	// URL子路径
	public final static String AREANAME = "area45";

	// 页面路径
	public final static String VIEWNAME = "view45";
	...
	// 后台验证码的会话key
	public final static String BG_VALIDATE_CODE_KEY = "BG_VALIDATE_CODE_KEY";
